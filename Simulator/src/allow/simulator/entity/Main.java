...
public class Main {
	...
	public static void main(String args[]) throws IOException {
		...
		map.addLayer(Layer.Type.DISTRICTS, Paths.get("/Users/Andi/Documents/DFKI/Allow Ensembles/Repository/repos/Software/DFKI Simulator/NetLogo/data/world/partitioning_fusion.layer"));
		...
		BufferedWriter wr = Files.newBufferedWriter(Paths.get("trento.agent"), Charset.defaultCharset());
	...
	private static Person createChild(int id, StreetMap map, IPlannerService planner) {
		...
		double carPreference = ThreadLocalRandom.current().nextDouble(0.7);
	...
	private static int PROP_CAR_STUDENT = 50;
	...
	private static Person createStudent(int id, StreetMap map, IPlannerService planner) {
		...
		// } else {
		carPreference = ThreadLocalRandom.current().nextDouble(0.7);
